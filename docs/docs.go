...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/authors/grants": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Leitor e item",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/library.AuthorGrantRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/library.LibraryItemResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/catalog.CollectionResponse"
                            }
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/catalog.CreateCollectionRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/catalog.UpdateCollectionRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/catalog/collections/{collectionId}/books": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "description": "IDs dos livros na ordem desejada",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/catalog.ReplaceCollectionBooksRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/me/library": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Tipo e ID do item",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/library.AddLibraryItemRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/me/library/{itemType}/{itemId}": {
            "delete": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "book ou collection",
                        "name": "itemType",
                        "in": "path",
                        "required": true
                    },
        ...
        "/api/v1/purchases": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Linhas da compra (obras ou coleções)",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/commerce.CreatePurchaseRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/commerce.PurchaseResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "catalog.CollectionBookItemResponse": {
            "type": "object",
            "properties": {
                "book": {
                    "$ref": "#/definitions/catalog.BookResponse"
        ...
        "catalog.CollectionResponse": {
            ...
            "properties": {
                ...
                "books": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/catalog.CollectionBookItemResponse"
                    }
                },
                "cover_image_url": {
                    "type": "string"
        ...
        "catalog.CreateCollectionRequest": {
            "type": "object",
            "required": [
                "slug",
                "title"
        ...
        "catalog.ReplaceCollectionBooksRequest": {
            "type": "object",
            "properties": {
                "book_ids": {
                    "description": "Ordem define a sequência na coleção; lista vazia remove todos os livros.",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
        ...
        "catalog.UpdateCollectionRequest": {
            "type": "object",
            "properties": {
                "access_tier": {
                    "type": "string"
        ...
        "commerce.CreatePurchaseRequest": {
            "type": "object",
            "required": [
                "lines"
            ],
            "properties": {
                "lines": {
                    ...
                    "minItems": 1,
                    "items": {
                        "$ref": "#/definitions/commerce.PurchaseLineRequest"
                    }
                }
            }
        },
        "commerce.PurchaseLineRequest": {
            "type": "object",
            "required": [
                "item_id",
                "item_type"
        ...
        "commerce.PurchaseResponse": {
            ...
            "properties": {
                ...
                "lines": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/commerce.PurchaseLineResponse"
                    }
                },
                "paid_at": {
                    "type": "string"
        ...
        "library.LibraryItemResponse": {
            "type": "object",
            "properties": {
                "book": {
                    "$ref": "#/definitions/library.BookSummary"
                },
                "collection": {
                    "$ref": "#/definitions/library.CollectionSummary"
                },
                "created_at": {
                    "type": "string"
                },
